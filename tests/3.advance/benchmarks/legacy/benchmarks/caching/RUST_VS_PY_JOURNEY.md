...
**— eXonware Backend Team, Developer & Founder**
...
The developer and founder of the code, eXonware Backend Team, doesn't really see any value in moving things to Rust at this time. The performance efficiency that exists in Python is already high because:
