...
- Present REF docs: `REF_IDEA.md`, `REF_PROJECT.md`, `REF_PLAN.md`, `REF_ARCH.md`, `REF_API.md`, `REF_BENCH.md`, `REF_USAGE.md`
...
- `REF_DX.md` (DX contract for this library)
- `REF_QA.md` (QA gates for this library)
...
- `REPORT_TEST.md` (test status artifact)
...
- Not in canonical locations (`docs/changes/`, `docs/_archive/`, `docs/logs/**`)

These must be consolidated and/or archived using the standard mapping rules (status into `REF_PROJECT.md#project-status-overview`, change details into `docs/changes/`, historic artifacts into `docs/_archive/`).
