...
@pytest.mark.xwsystem_unit      # Unit tests
@pytest.mark.xwsystem_integration # Integration tests
@pytest.mark.xwsystem_security  # Security-specific tests
@pytest.mark.xwsystem_serialization # Serialization tests
@pytest.mark.xwsystem_performance # Performance tests
```
...
```bash
# Core tests only
python -m pytest tests/core/ -v -m xwsystem_core

# Unit tests only
python -m pytest tests/unit/ -v -m xwsystem_unit

# Integration tests only
python -m pytest tests/integration/ -v -m xwsystem_integration

# Security tests only
python -m pytest tests/ -v -m xwsystem_security
```
