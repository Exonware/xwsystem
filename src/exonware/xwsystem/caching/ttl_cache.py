...
======================================
Production-grade TTL caching for xwsystem.
...
class TTLCache(ACache):
    ...
    def __init__(self, 
        ...
        # Call parent constructor (pass int for base; we preserve float TTL below)
        super().__init__(capacity=capacity, ttl=int(ttl) if ttl >= 1 else 1)
        self.ttl = float(ttl)  # Preserve fractional TTL so short values (e.g. 0.1s) work
